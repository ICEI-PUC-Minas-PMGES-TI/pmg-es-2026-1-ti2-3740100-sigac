...
export default function GestorDashboardPage() {
  ...
  if (loading) return <div className="text-teal-700">Carregando dashboard...</div>;
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-teal-800 mb-4">Dashboard e relatório mensal</h1>
          ...
          <section className="mb-6">
            ...
            <div className="card overflow-hidden p-0">
              {funcionarios.length === 0 ? (
                <p className="p-4 text-gray-500 text-sm">Nenhum funcionário cadastrado. <Link href={`/gestor/funcionarios?condominioId=${condominioId}`} className="text-teal-600 hover:underline">Cadastrar</Link></p>
              ) : (
          ...
          <section className="mb-6">
            ...
            <div className="card overflow-hidden p-0">
              {manutencoes.length === 0 ? (
                <p className="p-4 text-gray-500 text-sm">Nenhuma manutenção no período. <Link href={`/gestor/manutencoes?condominioId=${condominioId}`} className="text-teal-600 hover:underline">Registrar</Link></p>
              ) : (
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
          ...
          <section className="mb-6">
            ...
            <div className="card overflow-hidden p-0">
              {gastosProdutos.length === 0 ? (
                <p className="p-4 text-gray-500 text-sm">Nenhum gasto com produtos no período. <Link href={`/gestor/gastos?condominioId=${condominioId}`} className="text-teal-600 hover:underline">Lançar gasto</Link></p>
              ) : (
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
